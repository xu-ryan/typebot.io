...
const startParamsSchema = z
  .object({
    typebot: startTypebotSchema
      .or(z.string())
      .describe(
        'Either a Typebot ID or a Typebot object. If you provide a Typebot object, it will be executed in preview mode. ([How can I find my typebot ID?](https://docs.facto.com.cn/api-reference#how-to-find-my-typebotid)).'
      ),
    isPreview: z
      .boolean()
      .optional()
    ...
    prefilledVariables: z
      ...
      .optional()
      .describe(
        '[More info about prefilled variables.](https://docs.facto.com.cn/editor/variables#prefilled-variables)'
      ),
    isStreamEnabled: z
      .boolean()
      .optional()
