...
If you need more information about our Privacy and Security Policies, check out the [Privacy Policies](https://bot.facto.com.cn/privacy-policies).

## Where is my data stored?

Typebot relies on an AWS-managed database located in Singapore (ap-southeast-1).
...
You can delete your account and all its associated data at any time by sending an email to [hi@facto.hk](mailto:hi@facto.hk).
